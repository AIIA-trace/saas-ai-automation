                    ...
                    <button type="button" class="btn btn-primary" onclick="saveUnifiedConfig()">
                        <i class="fas fa-save me-2"></i>Guardar Configuración
                            ...
                            <div class="card-body py-4 px-4">
                                <!-- Mensaje de Configuración Centralizada -->
                                <div class="alert alert-info">
                                    <h6 class="alert-heading"><i class="fas fa-info-circle me-2"></i>Configuración Centralizada</h6>
                                    <p class="mb-0">Los datos de la empresa y la configuración de llamadas están disponibles en la pestaña <strong>"Configuración del Bot"</strong> para mantener todos los ajustes unificados.</p>
                                </div>
                            </div>
                        </div>
