                                                ...
                                                <div class="card-body p-3">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="alert alert-info mb-0" role="alert">
                                                            <strong>Isidora (Multilingüe)</strong><br>
...
function loadCallConfiguration() {
    ...
    .then(response => {
        ...
        // Voz fija: Isidora Multilingüe para todos los usuarios
        console.log('🎤 Voz configurada: Isidora (es-ES-IsidoraMultilingualNeural)');
...
function loadProfileData() {
    ...
    .then(response => {
        ...
        // FIX: El endpoint /api/profile devuelve response.client.businessHoursConfig, no response.data
        console.log('🔍 DEBUG CRÍTICO - Estructura completa de response:', response);
        console.log('🔍 DEBUG CRÍTICO - response.client:', response.client);
        console.log('🔍 DEBUG CRÍTICO - response.client.businessHoursConfig:', response.client?.businessHoursConfig);
        ...
        const config = {
            ...
            callConfig: (() => {
                ...
                const config = {
                    ...
                    voiceId: 'isidora', // Voz fija para todos los usuarios
...
async function loadAzureVoices() {
    // Voz fija configurada: Isidora Multilingüe
    console.log('🎵 Voz configurada: Isidora (es-ES-IsidoraMultilingualNeural)');
